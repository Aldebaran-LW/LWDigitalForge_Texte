-- ========================================
-- Adicionar colunas is_liberado e data_vencimento em profiles
-- ========================================
...
BEGIN
  -- CONDIÇÃO 1: Verificar se tem compra vitalícia (LIFETIME)
  SELECT EXISTS(
    SELECT 1
  ...
  -- CONDIÇÃO 2: Verificar se tem compra/assinatura ativa (não vitalício)
  SELECT 
    EXISTS(
      SELECT 1
      FROM public.user_purchases
  ...
  -- CONDIÇÃO 3: Verificar se tem trial ativo
  SELECT 
    EXISTS(
      SELECT 1
...
-- 7. Atualizar todos os usuários existentes (INICIALIZAÇÃO)
...
-- Ver alguns usuários com as novas colunas
