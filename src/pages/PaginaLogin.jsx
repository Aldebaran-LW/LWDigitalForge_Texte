  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Acesse o portal do cliente." />
      </Helmet>

      <div className="min-h-screen flex">
        {/* Left panel — branding */}
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-violet-700 items-center justify-center p-12">
          {/* Pattern */}
          <div
          ...
          <div className="absolute -bottom-20 -left-20 w-80 h-80 rounded-full bg-violet-400/20 blur-[80px]" />
          ...
          <div className="relative z-10 max-w-md">
            ...
            <p className="text-blue-100 text-base leading-relaxed mb-10">
              Acesse sua conta para gerenciar suas soluções digitais e acompanhar seus projetos.
            </p>

            <div className="space-y-3">
              {['Acesso às suas soluções', 'Acompanhe seus projetos', 'Suporte dedicado'].map((f, i) => (
                <div key={i} className="flex items-center gap-3 text-blue-100 text-sm">
                  <div className="w-5 h-5 rounded-full bg-cyan-400/30 border border-cyan-400/50 flex items-center justify-center flex-shrink-0">
        ...
        {/* Right panel — form */}
        <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white dark:bg-[#080C14]">
          <motion.div
          ...
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
              Não tem conta?{' '}
              <Link to="/cadastro" className="text-blue-600 dark:text-blue-400 font-medium hover:underline">
                Cadastre-se grátis
              </Link>
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link to="/esqueci-senha" className="text-xs text-blue-600 dark:text-blue-400 hover:underline">
                    Esqueceu?
                  </Link>
                </div>
                <div className="relative">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold text-sm shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition-all group"
              >
                {loading ? (
