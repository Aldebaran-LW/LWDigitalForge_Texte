        ...
        >
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              {products.length === 0 ? (
                <tr>
                  <td colSpan="5" className="text-center py-8 text-gray-500 dark:text-gray-400">Nenhum produto encontrado.</td>
                </tr>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right space-x-2">
                    <Button asChild variant="ghost" size="icon" className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-400">
                        <Link to={`/admin/produtos/${product.id}/editar`}><Edit className="h-4 w-4" /></Link>
                    </Button>
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button variant="ghost" size="icon" className="text-red-500 hover:text-red-600 dark:hover:text-red-400">
