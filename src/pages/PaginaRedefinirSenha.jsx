                ...
                >
                    ...
                    >
                        <div className="text-center mb-6 sm:mb-8">
                            <h1 className="text-2xl sm:text-3xl font-bold text-gradient">Redefinir Senha</h1>
                            <p className="text-sm sm:text-base text-gray-600 dark:text-[#F9FAFB]/70 mt-2">Crie uma nova senha forte e segura.</p>
                        </div>

                        <div className="mb-4 relative">
                            <label className="block text-gray-700 dark:text-[#F9FAFB]/80 text-sm font-bold mb-1.5 sm:mb-2" htmlFor="new-password">Nova Senha</label>
                            <div className="relative">
                                <Lock className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                                <input 
                                  id="new-password" 
                                ...
                                />
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 min-h-[44px] min-w-[44px] flex items-center justify-center">
                        ...
                        <div className="mb-4 sm:mb-6 relative">
                            <label className="block text-gray-700 dark:text-[#F9FAFB]/80 text-sm font-bold mb-1.5 sm:mb-2" htmlFor="confirm-new-password">Confirmar Nova Senha</label>
                            <div className="relative">
                                <Lock className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                                <input 
                                ...
                                />
                                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 min-h-[44px] min-w-[44px] flex items-center justify-center">
