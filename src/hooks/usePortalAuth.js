/**
 * Hook para Verificação de Acesso via Portal - LW StockForge
 * 
...
// ✅ CONFIGURADO: ID do produto StockForge
const PRODUCT_ID = '0cb79942-0696-4c43-bae4-d2acc46804cd';

// ✅ CONFIGURADO: Rota padrão (página inicial)
const DEFAULT_ROUTE = '/';
